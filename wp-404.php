...
/*
Plugin Name: WP-404
Plugin URI: http://www.littlebizzy.com/plugins/wp-404/
Description: Easily keep track of all 404 errors generated on your website.
Version: 1.0
Author: Little Bizzy
		...
		print('
			<div class="wrap">
				...
				<form name="ak_404" action="'.get_bloginfo('wpurl').'/wp-admin/options-general.php" method="post">
					...
					<p class="submit">
						<input type="submit" name="submit" value="'.__('Update Settings', '404-notifier').'" />
					</p>
				</form>
			</div>
		');
